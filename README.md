...
Exemple [source](https://github.com/fedre30/Jelly-Dodge/blob/master/game.js) :
```
class Player
{
    constructor() {
...
Aujourd'hui, la plupart des développeurs ne codent pas en pure Node.js mais utilisent aussi un framework.
Le plus utilisé est [Express](https://expressjs.com).

Exemple de script pour upload une vidéo ([source](https://github.com/fedre30/Fanhub/blob/master/backend.js))
